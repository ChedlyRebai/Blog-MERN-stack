      ...
      <div className="h-full flex">
        ...
        <div className="hidden lg:flex lg:flex-shrink-0">
          <div className="flex flex-col w-20">
            <div className="flex-1 flex flex-col min-h-0 overflow-y-auto bg-rose-600">
              <div className="flex-1">
                <div className="bg-rose-700 py-4 flex items-center justify-center">
                  <img
                    className="h-8 w-auto"
                ...
                <nav aria-label="Sidebar" className="py-6 flex flex-col items-center space-y-3">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center p-4 rounded-lg text-blue-200 hover:bg-rose-700"
                    >
        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
          ...
          <div className="lg:hidden">
            <div className="bg-rose-600 py-2 px-4 flex items-center justify-between sm:px-6">
              <div>
                <img
                  className="h-8 w-auto"
                  src="https://tailwindui.com/img/logos/workflow-mark.svg?color=white"
              ...
              <div>
                <button
                  type="button"
                  className="-mr-3 h-12 w-12 inline-flex items-center justify-center bg-rose-600 rounded-md text-white hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
            ...
            <div className="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
              ...
              <nav aria-label="Breadcrumb" className="bg-white border-b border-blue-gray-200 xl:hidden">
                <div className="max-w-3xl mx-auto py-3 px-4 flex items-start sm:px-6 lg:px-8">
                  ...
                  >
                    <ChevronLeft className="h-5 w-5 text-blue-gray-400" aria-hidden="true" />
                    <span>Settings</span>
                  </a>
                </div>
              </nav>
                  ...
                  <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
                    ...
                    <form className="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
                      ...
                      <div className="pt-8 flex justify-end">
                        ...
                        <button
                          type="submit"
                          className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-rose-600 hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        >
                          Save
                        </button>
                      </div>
